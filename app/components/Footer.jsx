...
function Footer() {
  ...
  return (
    <footer className="mt-8 bg-black-50">
      <div className="mx-auto flex w-full max-w-[1806px] flex-col-reverse items-center justify-between gap-8 px-6 py-5 font-semibold text-black-200 md:flex-row md:items-start md:px-12 md:py-9">
